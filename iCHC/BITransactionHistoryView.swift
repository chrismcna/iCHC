...
class BITransactionHistoryView: UIView, UITableViewDelegate, UITableViewDataSource, BISettingsTopViewDelegate {
    ...
    public func reloadTxHistoryView() {
        ...
        for tx in TransactionInfo.loadAll().reversed() {
            let txDetail = TransactionDetail(tx: tx, pubKeyPrefix: ChaincoinPrefixes.pubKeyPrefix, scriptHashPrefix: ChaincoinPrefixes.scriptHashPrefix)
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.amountLabel.text = String(Double(tx.amount) / 100000000) + " CHC"
